...
WebUI.selectOptionByLabel(findTestObject('AddFamilyMember/SubType_List'), 'Cousin', false)
...
WebUI.setText(findTestObject('AddFamilyMember/FirstName_TextField'), 'مينا')

WebUI.setText(findTestObject('AddFamilyMember/FamilyName_TextField'), 'مجدي')
